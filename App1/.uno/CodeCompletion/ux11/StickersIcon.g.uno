...
public partial class StickersIcon: Icon
{
    ...
    void InitializeUX()
    {
        ...
        temp1.Density = 1f;
        temp1.File = new global::Uno.UX.BundleFileSource(import global::Uno.IO.BundleFile("../../../assets/stickers@1x.png"));
        temp2.Density = 2f;
        temp2.File = new global::Uno.UX.BundleFileSource(import global::Uno.IO.BundleFile("../../../assets/stickers@2x.png"));
        this.Source = temp;
    }
}
